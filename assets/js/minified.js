!function(t, e) {
    ...
    b.extend = b.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = r[e],
                    r !== (n = t[e]) && (h && n && (b.isPlainObject(n) || (s = Array.isArray(n))) ? (s ? (s = !1,
                    o = i && Array.isArray(i) ? i : []) : o = i && b.isPlainObject(i) ? i : {},
                    r[e] = b.extend(h, o, n)) : void 0 !== n && (r[e] = n));
        return r
    }
    ,
    b.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (x(Object(t)) ? b.merge(i, "string" == typeof t ? [t] : t) : a.call(i, t)),
            i
        },
    ...
    var C = function(t) {
        var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, y, b = "sizzle" + 1 * new Date, w = t.document, x = 0, C = 0, k = rt(), T = rt(), D = rt(), S = function(t, e) {
            return t === e && (u = !0),
            0
        }, E = {}.hasOwnProperty, I = [], A = I.pop, P = I.push, O = I.push, N = I.slice, M = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, H = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", z = "[\\x20\\t\\r\\n\\f]", L = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", W = "\\[" + z + "*(" + L + ")(?:" + z + "*([*^$|!~]?=)" + z + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + L + "))|)" + z + "*\\]", j = ":(" + L + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", R = new RegExp(z + "+","g"), F = new RegExp("^" + z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + z + "+$","g"), q = new RegExp("^" + z + "*," + z + "*"), B = new RegExp("^" + z + "*([>+~]|" + z + ")" + z + "*"), $ = new RegExp("=" + z + "*([^\\]'\"]*?)" + z + "*\\]","g"), U = new RegExp(j), Y = new RegExp("^" + L + "$"), K = {
            ID: new RegExp("^#(" + L + ")"),
            CLASS: new RegExp("^\\.(" + L + ")"),
            TAG: new RegExp("^(" + L + "|[*])"),
            ATTR: new RegExp("^" + W),
        ...
        }, V = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, X = /^[^{]+\{\s*\[native \w/, G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Z = /[+~]/, J = new RegExp("\\\\([\\da-f]{1,6}" + z + "?|(" + z + ")|.)","ig"), tt = function(t, e, i) {
            var n = "0x" + e - 65536;
                ...
                if (i.qsa && !D[t + " "] && (!m || !m.test(t))) {
                    if (1 !== x)
                        ...
                        a = (f = r(t)).length; a--; )
                            f[a] = "#" + c + " " + vt(f[a]);
                        v = f.join(","),
                        _ = Z.test(t) && gt(e.parentNode) || e
                    }
                    if (v)
                        try {
                            return O.apply(n, _.querySelectorAll(v)),
                            n
                        } catch (t) {} finally {
        ...
        d = ot.setDocument = function(t) {
            ...
            (i.qsa = X.test(p.querySelectorAll)) && (lt(function(t) {
                ...
                t.querySelectorAll("[selected]").length || m.push("\\[" + z + "*(?:value|" + H + ")"),
            ...
            S = e ? function(t, e) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !i.sortDetached && e.compareDocumentPosition(t) === n ? t === p || t.ownerDocument === w && y(w, t) ? -1 : e === p || e.ownerDocument === w && y(w, e) ? 1 : c ? M(c, t) - M(c, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return u = !0,
        ...
        (n = ot.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return K.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && U.test(i) && (e = r(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, i, n, s) {
                    ...
                    : function(e, i, l) {
                        ...
                        if (m) {
                            ...
                            r && _) {
                                for (y = (p = (h = (c = (u = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === x && h[1]) && h[2],
                                d = p && m.childNodes[p]; d = ++p && d && d[g] || (y = p = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++y && d === e) {
                                        c[t] = [x, p, y];
                                        break
                                    }
                            } else if (_ && (y = p = (h = (c = (u = (d = e)[b] || (d[b] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] || [])[0] === x && h[1]),
                            !1 === y)
                                for (; (d = ++p && d && d[g] || (y = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++y || (_ && ((c = (u = d[b] || (d[b] = {}))[d.uniqueID] || (u[d.uniqueID] = {}))[t] = [x, y]),
                                d !== e)); )
                                    ;
                ...
                PSEUDO: function(t, e) {
                    ...
                    return s[b] ? s(e) : s.length > 1 ? (i = [t, t, "", e],
        ...
        function _t(t, e, i) {
            ...
            : function(e, i, l) {
                ...
                if (l) {
                    ...
                    for (; e = e[n]; )
                        if (1 === e.nodeType || r)
                            if (c = (u = e[b] || (e[b] = {}))[e.uniqueID] || (u[e.uniqueID] = {}),
            ...
            at(function(o, r, a, l) {
                var h, c, u, d = [], p = [], f = r.length, g = o || function(t, e, i) {
                    for (var n = 0, s = e.length; n < s; n++)
                        ot(t, e[n], i);
                    return i
                }(e || "*", a.nodeType ? [a] : a, []), m = !t || !o && e ? g : bt(g, d, t, a, l), v = i ? s || (o ? t : f || n) ? [] : r : m;
                if (i && i(m, v, a, l),
                n)
                    for (h = bt(v, p),
                    n(h, [], a, l),
                ...
                if (i = n.relative[t[l].type])
                    ...
                    if ((i = n.filter[t[l].type].apply(null, t[l].matches))[b]) {
                        ...
                        return wt(l > 1 && yt(d), l > 1 && vt(t.slice(0, l - 1).concat({
                            value: " " === t[l - 2].type ? "*" : ""
                        })).replace(F, "$1"), i, l < s && xt(t.slice(l, s)), s < o && xt(t = t.slice(s)), s < o && vt(t))
                    }
                    d.push(i)
                }
            return yt(d)
        ...
        function Ct(t, e) {
            var i = e.length > 0
              ...
              , o = function(o, r, a, l, c) {
                var u, f, m, v = 0, _ = "0", y = o && [], b = [], w = h, C = o || s && n.find.TAG("*", c), k = x += null == w ? 1 : Math.random() || .1, T = C.length;
                for (c && (h = r === p || r || c); _ !== T && null != (u = C[_]); _++) {
                    if (s && u) {
                        for (f = 0,
        ...
        l = ot.select = function(t, e, i, s) {
            ...
            1 === p.length) {
                ...
                !n.relative[c = h.type]); )
                    if ((u = n.find[c]) && (s = u(h.matches[0].replace(J, tt), Z.test(l[0].type) && gt(e.parentNode) || e))) {
                        if (l.splice(o, 1),
                        !(t = s.length && vt(l)))
                            return O.apply(i, s),
                            i;
            ...
            return (d || a(t, p))(s, e, !g, i, !e || Z.test(t) && gt(e.parentNode) || e),
            i
        }
        ,
    ...
    var E = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
    function I(t, e, i) {
        return g(e) ? b.grep(t, function(t, n) {
    ...
    b.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? b.find.matchesSelector(n, t) ? [n] : [] : b.find.matches(t, b.grep(e, function(t) {
            return 1 === t.nodeType
        }))
    }
    ,
    b.fn.extend({
        find: function(t) {
            ...
            if ("string" != typeof t)
                return this.pushStack(b(t).filter(function() {
                    for (e = 0; e < n; e++)
                        if (b.contains(s[e], this))
                            return !0
                }));
    ...
    (b.fn.init = function(t, e, i) {
        ...
        if (i = i || A,
        "string" == typeof t) {
            if (!(s = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : P.exec(t)) || !s[1] && e)
                return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
            if (s[1]) {
                if (e = e instanceof b ? e[0] : e,
                b.merge(this, b.parseHTML(s[1], e && e.nodeType ? e.ownerDocument || e : n, !0)),
        ...
        this.length = 1,
        this) : g(t) ? void 0 !== i.ready ? i.ready(t) : t(b) : b.makeArray(t, this)
    }
    ).prototype = b.fn,
    A = b(n);
    ...
    b.fn.extend({
        has: function(t) {
            ...
            return this.filter(function() {
                for (var t = 0; t < i; t++)
                    if (b.contains(this, e[t]))
                        return !0
            })
        },
        closest: function(t, e) {
            var i, n = 0, s = this.length, o = [], r = "string" != typeof t && b(t);
            if (!D.test(t))
                for (; n < s; n++)
                    for (i = this[n]; i && i !== e; i = i.parentNode)
                        if (i.nodeType < 11 && (r ? r.index(i) > -1 : 1 === i.nodeType && b.find.matchesSelector(i, t))) {
                            o.push(i);
                            break
                        }
    ...
    b.each({
        ...
        b.fn[t] = function(i, n) {
            ...
            this.length > 1 && (N[t] || b.uniqueSort(s),
            O.test(t) && s.reverse()),
            this.pushStack(s)
        }
    });
            ...
            add: function() {
                ...
                function e(i) {
                    b.each(i, function(i, n) {
                        g(n) ? t.unique && h.has(n) || o.push(n) : n && n.length && "string" !== y(n) && e(n)
                    })
                }(arguments),
                i && !e && l()),
                this
                ...
                then: function(e, n, s) {
                    ...
                    function r(e, i, n, s) {
                        return function() {
                            var a = this
                              ...
                              , h = function() {
                                ...
                                if (!(e < o)) {
                                    ...
                                    g(h) ? s ? h.call(t, r(o, i, z, s), r(o, i, L, s)) : (o++,
                                    h.call(t, r(o, i, z, s), r(o, i, L, s), r(o, i, z, i.notifyWith))) : (n !== z && (a = void 0,
                                    l = [t]),
                                    (s || i.resolveWith)(a, l))
                                }
                            }
                              , c = s ? h : function() {
                                try {
                                    ...
                                    b.Deferred.exceptionHook && b.Deferred.exceptionHook(t, c.stackTrace),
                                    e + 1 >= o && (n !== L && (a = void 0,
                                    l = [t]),
                                    i.rejectWith(a, l))
                                }
                            ...
                            ;
                            e ? c() : (b.Deferred.getStackHook && (c.stackTrace = b.Deferred.getStackHook()),
                            t.setTimeout(c))
                        }
                    }
    ...
    b.extend({
        ...
        readyWait: 1,
        ready: function(t) {
            (!0 === t ? --b.readyWait : b.isReady) || (b.isReady = !0,
            !0 !== t && --b.readyWait > 0 || R.resolveWith(n, [b]))
        }
    }),
    b.ready.then = R.then,
    "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll ? t.setTimeout(b.ready) : (n.addEventListener("DOMContentLoaded", F),
    ...
    b.extend({
        queue: function(t, e, i) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                n = Q.get(t, e),
                i && (!n || Array.isArray(i) ? n = Q.access(t, e, b.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    b.fn.extend({
        queue: function(t, e) {
            ...
            t = "fx",
            i--),
            arguments.length < i ? b.queue(this[0], t) : void 0 === e ? this : this.each(function() {
        ...
        promise: function(t, e) {
            var i, n = 1, s = b.Deferred(), o = this, r = this.length, a = function() {
                --n || s.resolveWith(o, [o])
            };
            for ("string" != typeof t && (e = t,
            t = void 0),
            t = t || "fx"; r--; )
                (i = Q.get(o[r], t + "queueHooks")) && i.empty && (n++,
                i.empty.add(a));
            return a(),
            s.promise(e)
        }
    ...
    function ot(t, e, i, n) {
        ...
        , l = a(), h = i && i[3] || (b.cssNumber[e] ? "" : "px"), c = (b.cssNumber[e] || "px" !== h && +l) && et.exec(b.css(t, e));
        if (c && c[3] !== h) {
            for (l /= 2,
            h = h || c[3],
            c = +l || 1; r--; )
        ...
        for (var o, r, a, l, h, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            if ((o = t[p]) || 0 === o)
                if ("object" === y(o))
                    ...
                    c = l[0]; c--; )
                        r = r.lastChild;
                    b.merge(d, r.childNodes),
                    (r = u.firstChild).textContent = ""
                } else
                    d.push(e.createTextNode(o));
        for (u.textContent = "",
        p = 0; o = d[p++]; )
            if (n && b.inArray(o, n) > -1)
                s && s.push(o);
            else if (h = b.contains(o.ownerDocument, o),
        ...
        remove: function(t, e, i, n, s) {
            ...
            if (m && (l = m.events)) {
                for (h = (e = (e || "").match(H) || [""]).length; h--; )
                    if (p = g = (a = bt.exec(e[h]) || [])[1],
                    f = (a[2] || "").split(".").sort(),
                    p) {
                        for (u = b.event.special[p] || {},
                        ...
                        r && !d.length && (u.teardown && !1 !== u.teardown.call(t, f, m.handle) || b.removeEvent(t, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
                            b.event.remove(t, p + e[h], i, n, !0);
                b.isEmptyObject(l) && Q.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, i, n, s, o, r, a = b.event.fix(t), l = new Array(arguments.length), h = (Q.get(this, "events") || {})[a.type] || [], c = b.event.special[a.type] || {};
            for (l[0] = a,
            e = 1; e < arguments.length; e++)
                l[e] = arguments[e];
            if (a.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                for (r = b.event.handlers.call(this, a, h),
                e = 0; (s = r[e++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (o = s.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        void 0 !== (n = ((b.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && h.nodeType && !("click" === t.type && t.button >= 1))
                for (; h !== this; h = h.parentNode || this)
                    if (1 === h.nodeType && ("click" !== t.type || !0 !== h.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[s = (n = e[i]).selector + " "] && (r[s] = n.needsContext ? b(s, this).index(h) > -1 : b.find(s, this, null, [h]).length),
                            r[s] && o.push(n);
                        o.length && a.push({
                            elem: h,
                            handlers: o
    ...
    b.each({
        ...
        b.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return n && (n === this || b.contains(this, n)) || (t.type = s.origType,
    ...
    b.fn.extend({
        ...
        off: function(t, e, i) {
            ...
            if (t && t.preventDefault && t.handleObj)
                ...
                b(t.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler),
                this;
            if ("object" == typeof t) {
                for (s in t)
                    this.off(s, e, t[s]);
        ...
        if (1 === e.nodeType) {
            ...
            h = o.events))
                ...
                h)
                    for (i = 0,
                    n = h[s].length; i < n; i++)
                        b.event.add(e, s, h[s][i]);
            X.hasData(t) && (a = X.access(t),
            l = b.extend({}, a),
            X.set(e, l))
        }
    }
    ...
    function Mt(t, e, i, n) {
        ...
        if (d && (o = (s = mt(e, t[0].ownerDocument, !1, t, n)).firstChild,
        1 === s.childNodes.length && (s = o),
        o || n)) {
            for (l = (a = b.map(pt(s, "script"), At)).length; u < d; u++)
                h = s,
                u !== p && (h = b.clone(h, !0, !0),
                l && b.merge(a, pt(h, "script"))),
                i.call(t[u], h, u);
            if (l)
                ...
                u = 0; u < l; u++)
                    h = a[u],
                    ut.test(h.type || "") && !Q.access(h, "globalEval") && b.contains(c, h) && (h.src && "module" !== (h.type || "").toLowerCase() ? b._evalUrl && b._evalUrl(h.src) : _(h.textContent.replace(Et, ""), c, h))
        }
        return t
    }
    function Ht(t, e, i) {
        for (var n, s = e ? b.filter(e, t) : t, o = 0; null != (n = s[o]); o++)
            ...
            n.parentNode && (i && b.contains(n.ownerDocument, n) && ft(pt(n, "script")),
    ...
    b.extend({
        ...
        clone: function(t, e, i) {
            var n, s, o, r, a = t.cloneNode(!0), l = b.contains(t.ownerDocument, t);
            ...
            if (e)
                if (i)
                    ...
                    Ot(t, a);
            return (r = pt(a, "script")).length > 0 && ft(r, !l && pt(t, "script")),
            a
        },
    ...
    b.fn.extend({
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (b.cleanData(pt(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return q(this, function(t) {
                ...
                if (void 0 === t && 1 === e.nodeType)
                    return e.innerHTML;
                if ("string" == typeof t && !Dt.test(t) && !dt[(ct.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = b.htmlPrefilter(t);
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (b.cleanData(pt(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return Mt(this, arguments, function(e) {
                ...
                b.inArray(this, t) < 0 && (b.cleanData(pt(this)),
    ...
    function jt(t, e, i) {
        ...
        return (i = i || Lt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || b.contains(t.ownerDocument, t) || (r = b.style(t, e)),
        !f.pixelBoxStyles() && zt.test(r) && Wt.test(e) && (n = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    function Qt(t, e, i, n, s, o) {
        ...
        for (; r < 4; r += 2)
            ...
            n ? ("content" === i && (l -= b.css(t, "padding" + it[r], !0, s)),
            "margin" !== i && (l -= b.css(t, "border" + it[r] + "Width", !0, s))) : (l += b.css(t, "padding" + it[r], !0, s),
            "padding" !== i ? l += b.css(t, "border" + it[r] + "Width", !0, s) : a += b.css(t, "border" + it[r] + "Width", !0, s));
    ...
    function Xt(t, e, i) {
        ...
        ("auto" === s || !parseFloat(s) && "inline" === b.css(t, "display", !1, n)) && (s = t["offset" + e[0].toUpperCase() + e.slice(1)],
        r = !0),
    ...
    b.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                o = "number"),
                null != i && i == i && ("number" === o && (i += s && s[3] || (b.cssNumber[a] ? "" : "px")),
        ...
        css: function(t, e, i, n) {
            ...
            (r = b.cssHooks[e] || b.cssHooks[a]) && "get"in r && (s = r.get(t, !0, i)),
            void 0 === s && (s = jt(t, e, n)),
    ...
    b.each(["height", "width"], function(t, e) {
        b.cssHooks[e] = {
            get: function(t, i, n) {
                if (i)
                    return !Ft.test(b.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Xt(t, e, n) : st(t, Bt, function() {
                        return Xt(t, e, n)
                    })
            },
            set: function(t, i, n) {
                var s, o = Lt(t), r = "border-box" === b.css(t, "boxSizing", !1, o), a = n && Qt(t, e, n, r, o);
                return r && f.scrollboxSize() === o.position && (a -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(o[e]) - Qt(t, e, "border", !1, o) - .5)),
    ...
    b.cssHooks.marginLeft = Rt(f.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(jt(t, "marginLeft")) || t.getBoundingClientRect().left - st(t, {
                marginLeft: 0
            }, function() {
    ...
    function ie() {
        Jt && (!1 === n.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(ie) : t.setTimeout(ie, b.fx.interval),
        b.fx.tick())
    }
    function ne() {
    ...
    function re(t, e, i) {
        var n, s, o = 0, r = re.prefilters.length, a = b.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (s)
                return !1;
            for (var e = Zt || ne(), i = Math.max(0, h.startTime + h.duration - e), n = 1 - (i / h.duration || 0), o = 0, r = h.tweens.length; o < r; o++)
                h.tweens[o].run(n);
            ...
            createTween: function(e, i) {
                var n = b.Tween(t, h.opts, e, i, h.opts.specialEasing[e] || h.opts.easing);
        ...
        for (function(t, e) {
            ...
            if (n = re.prefilters[o].call(h, t, c, h.opts))
                return g(n.stop) && (b._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)),
                n;
        return b.map(c, oe, h),
    ...
    b.Animation = b.extend(re, {
        ...
        prefilters: [function(t, e, i) {
            var n, s, o, r, a, l, h, c, u = "width"in e || "height"in e, d = this, p = {}, f = t.style, g = t.nodeType && nt(t), m = Q.get(t, "fxshow");
            for (n in i.queue || (null == (r = b._queueHooks(t, "fx")).unqueued && (r.unqueued = 0,
            a = r.empty.fire,
            ...
            d.always(function() {
                d.always(function() {
                    r.unqueued--,
                    b.queue(t, "fx").length || r.empty.fire()
                })
            })),
            e)
                if (s = e[n],
            ...
            if ((l = !b.isEmptyObject(e)) || !b.isEmptyObject(p))
                ...
                "none" === (c = b.css(t, "display")) && (h ? c = h : (lt([t], !0),
                h = t.style.display || h,
                c = b.css(t, "display"),
                lt([t]))),
                ("inline" === c || "inline-block" === c && null != h) && "none" === b.css(t, "float") && (l || (d.done(function() {
                    f.display = h
                }),
                null == h && (c = f.display,
                h = "none" === c ? "" : c)),
    ...
    b.fn.extend({
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"),
            this.each(function() {
                var e, i = Q.get(this), n = i[t + "queue"], s = i[t + "queueHooks"], o = b.timers, r = n ? n.length : 0;
                for (i.finish = !0,
                b.queue(this, t, []),
    ...
    b.each(["toggle", "show", "hide"], function(t, e) {
        ...
        b.fn[e] = function(t, n, s) {
            return null == t || "boolean" == typeof t ? i.apply(this, arguments) : this.animate(se(e, !0), t, n, s)
        }
    }),
    b.each({
        slideDown: se("show"),
    ...
    b.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? b.prop(t, e, i) : (1 === o && b.isXMLDoc(t) || (s = b.attrHooks[e.toLowerCase()] || (b.expr.match.bool.test(e) ? ae : void 0)),
                void 0 !== i ? null === i ? void b.removeAttr(t, e) : s && "set"in s && void 0 !== (n = s.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : s && "get"in s && null !== (n = s.get(t, e)) ? n : null == (n = b.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    ae = {
        set: function(t, e, i) {
            return !1 === e ? b.removeAttr(t, i) : t.setAttribute(i, i),
            i
        }
    },
    ...
    b.extend({
        prop: function(t, e, i) {
            var n, s, o = t.nodeType;
            if (3 !== o && 8 !== o && 2 !== o)
                return 1 === o && b.isXMLDoc(t) || (e = b.propFix[e] || e,
                s = b.propHooks[e]),
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && n ? e ? this.addClass(t) : this.removeClass(t) : g(t) ? this.each(function(i) {
                ...
                if (n)
                    ...
                    void 0 !== t && "boolean" !== i || ((e = de(this)) && Q.set(this, "__className__", e),
    ...
    b.fn.extend({
        val: function(t) {
            ...
            })) : s ? (e = b.valHooks[s.type] || b.valHooks[s.nodeName.toLowerCase()]) && "get"in e && void 0 !== (i = e.get(s, "value")) ? i : "string" == typeof (i = s.value) ? i.replace(fe, "") : null == i ? "" : i : void 0
        }
    }),
    b.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = b.makeArray(e), r = s.length; r--; )
                        ((n = s[r]).selected = b.inArray(b.valHooks.option.get(n), o) > -1) && (i = !0);
    ...
    b.extend(b.event, {
        trigger: function(e, i, s, o) {
            var r, a, l, h, c, d, p, f, v = [s || n], _ = u.call(e, "type") ? e.type : e, y = u.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = f = l = s = s || n,
            3 !== s.nodeType && 8 !== s.nodeType && !ge.test(_ + b.event.triggered) && (_.indexOf(".") > -1 && (_ = (y = _.split(".")).shift(),
            y.sort()),
            c = _.indexOf(":") < 0 && "on" + _,
            (e = e[b.expando] ? e : new b.Event(_,"object" == typeof e && e)).isTrigger = o ? 2 : 3,
            e.namespace = y.join("."),
            ...
            o || !p.trigger || !1 !== p.trigger.apply(s, i))) {
                ...
                for (r = 0; (a = v[r++]) && !e.isPropagationStopped(); )
                    ...
                    (d = (Q.get(a, "events") || {})[e.type] && Q.get(a, "handle")) && d.apply(a, i),
                    (d = c && a[c]) && d.apply && K(a) && (e.result = d.apply(a, i),
                    !1 === e.result && e.preventDefault());
                return e.type = _,
                o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), i) || !K(s) || c && g(s[_]) && !m(s) && ((l = s[c]) && (s[c] = null),
                b.event.triggered = _,
    ...
    b.fn.extend({
        ...
        triggerHandler: function(t, e) {
            var i = this[0];
            if (i)
                return b.event.trigger(t, e, i, !0)
        }
    }),
    f.focusin || b.each({
        focus: "focusin",
    ...
    b.parseXML = function(e) {
        ...
        return i && !i.getElementsByTagName("parsererror").length || b.error("Invalid XML: " + e),
        i
    }
    ;
    var be = /\[\]$/
    ...
    function ke(t, e, i, n) {
        ...
        if (Array.isArray(e))
            b.each(e, function(e, s) {
                i || be.test(t) ? n(t, s) : ke(t + "[" + ("object" == typeof s && null != s ? e : "") + "]", s, i, n)
            });
        else if (i || "object" !== y(e))
            n(t, e);
        else
            for (s in e)
                ke(t + "[" + s + "]", e[s], i, n)
    ...
    b.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !b(this).is(":disabled") && Ce.test(this.nodeName) && !xe.test(t) && (this.checked || !ht.test(t))
            }).map(function(t, e) {
                var i = b(this).val();
    ...
    b.extend({
        ...
        ajax: function(e, i) {
            ...
            e = void 0),
            i = i || {};
            var s, o, r, a, l, h, c, u, d, p, f = b.ajaxSetup({}, i), g = f.context || f, m = f.context && (g.nodeType || g.jquery) ? b(g) : b.event, v = b.Deferred(), _ = b.Callbacks("once memory"), y = f.statusCode || {}, w = {}, x = {}, C = "canceled", k = {
                readyState: 0,
            ...
            if (v.promise(k),
            f.url = ((e || f.url || ve.href) + "").replace(Ae, ve.protocol + "//"),
            ...
            null == f.crossDomain) {
                ...
                try {
                    h.href = f.url,
                    h.href = h.href,
                    f.crossDomain = Me.protocol + "//" + Me.host != h.protocol + "//" + h.host
                } catch (t) {
                    f.crossDomain = !0
                }
            }
            ...
            c)
                return k;
            for (d in (u = b.event && f.global) && 0 == b.active++ && b.event.trigger("ajaxStart"),
            ...
            delete f.data),
            !1 === f.cache && (o = o.replace(Se, "$1"),
            p = (ye.test(o) ? "&" : "?") + "_=" + _e++ + p),
            f.url = o + p),
            f.ifModified && (b.lastModified[o] && k.setRequestHeader("If-Modified-Since", b.lastModified[o]),
            ...
            k.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Ne + "; q=0.01" : "") : f.accepts["*"]),
            f.headers)
            ...
            function T(e, i, n, a) {
                ...
                h ? (f.ifModified && ((x = k.getResponseHeader("Last-Modified")) && (b.lastModified[o] = x),
    ...
    b.ajaxPrefilter("json jsonp", function(e, i, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            ...
            a ? e[a] = e[a].replace(Fe, "$1" + s) : !1 !== e.jsonp && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
            e.converters["script json"] = function() {
                return r || b.error(s + " was not called"),
                r[0]
            }
            ,
            e.dataTypes[0] = "json",
    ...
    b.parseHTML = function(t, e, i) {
        ...
        r = !i && [],
        (o = E.exec(t)) ? [e.createElement(o[1])] : (o = mt([t], e, r),
    ...
    b.offset = {
        setOffset: function(t, e, i) {
            var n, s, o, r, a, l, h = b.css(t, "position"), c = b(t), u = {};
        ...
        position: function() {
            if (this[0]) {
                ...
                if ("fixed" === b.css(n, "position"))
                    ...
                    for (e = this.offset(),
                    i = n.ownerDocument,
                    t = n.offsetParent || i.documentElement; t && (t === i.body || t === i.documentElement) && "static" === b.css(t, "position"); )
                        t = t.parentNode;
                    t && t !== n && 1 === t.nodeType && ((s = b(t).offset()).top += b.css(t, "borderTopWidth", !0),
        ...
        b.each({
            ...
            b.fn[n] = function(s, o) {
                ...
                return q(this, function(e, i, s) {
                    ...
                    Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === s ? b.css(e, i, a) : b.style(e, i, s, a)
                }, e, r ? s : void 0, r)
            }
        })
    }),
...
function(t, e, i) {
    ...
    function o(t, e) {
        if ("object" == typeof t)
            ...
            1 == n.length ? y[n[0]] = e : (!y[n[0]] || y[n[0]]instanceof Boolean || (y[n[0]] = new Boolean(y[n[0]])),
            y[n[0]][n[1]] = e),
            s([(e && 0 != e ? "" : "no-") + n.join("-")]),
            y._trigger(t, e)
        }
    ...
    function a(t, i, n, s) {
        var o, a, l, h, c = "modernizr", u = r("div"), d = function() {
            var t = e.body;
            return t || ((t = r(x ? "svg" : "body")).fake = !0),
            t
        }();
        if (parseInt(n, 10))
            for (; n--; )
                (l = r("div")).id = s ? s[n] : c + (n + 1),
                u.appendChild(l);
    ...
    function p(t, e, s, o) {
        ...
        for (var c, p, f, g, m, v = ["modernizr", "tspan", "samp"]; !P.style && v.length; )
            c = !0,
            P.modElem = r(v.shift()),
    ...
    function g(t, e, i, s, o) {
        ...
        return n(e, "string") || n(e, "undefined") ? p(a, e, s, o) : function(t, e, i) {
            var s;
            for (var o in t)
                if (t[o]in e)
                    return !1 === i ? t[o] : n(s = e[t[o]], "function") ? f(s, i || e) : s;
            return !1
    ...
    _._domPrefixes = k;
    var T, D = _._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
    _._prefixes = D,
    function() {
    ...
    _.on = function(t, e) {
        this._l[t] || (this._l[t] = []),
        this._l[t].push(e),
        y.hasOwnProperty(t) && setTimeout(function() {
            y._trigger(t, y[t])
        }, 0)
    }
    ,
    ...
    var S = function() {
        ...
        return function(e, n) {
            var s;
            return !!e && (n && "string" != typeof n || (n = r(n || "div")),
            !(s = (e = "on" + e)in n) && t && (n.setAttribute || (n = r("div")),
            n.setAttribute(e, ""),
    ...
    function() {
        ...
        for (var t, e, i = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], n = 0; n < i.length; n++)
            t = i[n].toLowerCase(),
            e = m("column" + i[n]),
            ("breakbefore" === t || "breakafter" === t || "breakinside" == t) && (e = e || m(i[n])),
    ...
    y.addAsyncTest(function() {
        var t, e, i = r("img"), n = "sizes"in i;
        !n && "srcset"in i ? ("data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==",
    ...
    function() {
        ...
        for (var a in v)
            if (v.hasOwnProperty(a)) {
                if (t = [],
                (e = v[a]).name && (t.push(e.name.toLowerCase()),
                e.options && e.options.aliases && e.options.aliases.length))
                    for (i = 0; i < e.options.aliases.length; i++)
                        t.push(e.options.aliases[i].toLowerCase());
                for (s = n(e.fn, "function") ? e.fn() : e.fn,
                o = 0; o < t.length; o++)
                    1 === (r = t[o].split(".")).length ? y[r[0]] = s : (!y[r[0]] || y[r[0]]instanceof Boolean || (y[r[0]] = new Boolean(y[r[0]])),
                    y[r[0]][r[1]] = s),
                    b.push((s ? "" : "no-") + r.join("-"))
            }
    }(),
...
function(t, e) {
      ...
      , T = function() {
        ...
        return i.toggle = function() {
            ...
            if (n) {
                ...
                if (s) {
                    if ("radio" === s.type)
                        if (s.checked && this._element.classList.contains(b))
                            t = !1;
                        else {
                        ...
                        "checkbox" === s.type ? "LABEL" === this._element.tagName && s.checked === this._element.classList.contains(b) && (t = !1) : t = !1;
                    t && (s.checked = !this._element.classList.contains(b),
                    e(s).trigger("change")),
                    s.focus(),
                    i = !1
                }
    ...
    var D = "carousel"
      ...
      , R = function() {
        ...
        i._slide = function(t, i) {
            var n, s, o, r = this, a = this._element.querySelector(L), h = this._getItemIndex(a), c = i || a && this._getItemByDirection(t, a), u = this._getItemIndex(c), d = Boolean(this._interval);
            if (o = t === N ? (n = "carousel-item-left",
            ...
            c && e(c).hasClass(z))
                ...
                if (e(this._element).hasClass("slide")) {
                    ...
                    e(a).one(l.TRANSITION_END, function() {
                        e(c).removeClass(n + " " + s).addClass(z),
    ...
    e(document).on(H.CLICK_DATA_API, "[data-slide], [data-slide-to]", R._dataApiClickHandler),
    ...
    var F = "collapse"
      ...
      , J = function() {
        ...
        i.show = function() {
            var i, n, s = this;
            if (!(this._isTransitioning || e(this._element).hasClass(V) || (this._parent && 0 === (i = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
            ...
            i && (n = e(i).not(this._selector).data(q)) && n._isTransitioning))) {
                ...
                !o.isDefaultPrevented()) {
                    ...
                    this._triggerArray.length && e(this._triggerArray).removeClass(G).attr("aria-expanded", !0),
                ...
                !i.isDefaultPrevented()) {
                    ...
                    if (0 < s)
                        for (var o = 0; o < s; o++) {
                            ...
                            null !== a && (e([].slice.call(document.querySelectorAll(a))).hasClass(V) || e(r).addClass(G).attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0),
                    ...
                    e(this._element).one(l.TRANSITION_END, function() {
                        ...
                        e(t._element).removeClass(X).addClass(Q).trigger(K.HIDDEN)
                    }).emulateTransitionEnd(h)
                }
            }
        }
        ...
        t._jQueryInterface = function(i) {
            return this.each(function() {
                var n = e(this)
                  , s = n.data(q)
                  , o = r({}, U, {}, n.data(), {}, "object" == typeof i && i ? i : {});
    ...
    var tt = "dropdown"
      ...
      , ft = function() {
        ...
        n._getPlacement = function() {
            ...
            e(this._menu).hasClass(ht) && (i = "top-end")) : t.hasClass("dropright") ? i = "right-start" : t.hasClass("dropleft") ? i = "left-start" : e(this._menu).hasClass(ht) && (i = "bottom-end"),
            i
        }
        ,
        ...
        t._dataApiKeydownHandler = function(i) {
            if ((/input|textarea/i.test(i.target.tagName) ? !(32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || e(i.target).closest(ut).length)) : ot.test(i.which)) && (i.preventDefault(),
            i.stopPropagation(),
    ...
    e(document).on(rt.KEYDOWN_DATA_API, ct, ft._dataApiKeydownHandler).on(rt.KEYDOWN_DATA_API, ut, ft._dataApiKeydownHandler).on(rt.CLICK_DATA_API + " " + rt.KEYUP_DATA_API, ft._clearMenus).on(rt.CLICK_DATA_API, ct, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
    ...
    var gt = "modal"
      ...
      , It = function() {
        ...
        i._showElement = function(t) {
            ...
            e(this._dialog).hasClass("modal-dialog-scrollable") && s ? s.scrollTop = 0 : this._element.scrollTop = 0,
        ...
        i._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                if (e(this._element).hasClass(Ct)) {
                    ...
                    e(this._backdrop).one(l.TRANSITION_END, o).emulateTransitionEnd(r)
                } else
                    o()
            } else
                t && t()
        ...
        t._jQueryInterface = function(i, n) {
            return this.each(function() {
                var s = e(this).data(mt)
                  , o = r({}, yt, {}, e(this).data(), {}, "object" == typeof i && i ? i : {});
                if (s || (s = new t(this,o),
                e(this).data(mt, s)),
                "string" == typeof i) {
                    if (void 0 === s[i])
    ...
    e(document).on(wt.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
        var i, n = this, s = l.getSelectorFromElement(this);
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(e), o = [].slice.call(n.body.querySelectorAll("*")), r = function(t) {
            ...
            r.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === At.indexOf(i) || Boolean(t.nodeValue.match(Pt) || t.nodeValue.match(Ot));
    ...
    var Mt = "tooltip"
      ...
      , Xt = function() {
        ...
        n.hide = function(t) {
            function i() {
                n._hoverState !== $t && s.parentNode && s.parentNode.removeChild(s),
                n._cleanTipClass(),
        ...
        n.setElementContent = function(t, i) {
            "object" != typeof i || !i.nodeType && !i.jquery ? this.config.html ? (this.config.sanitize && (i = Nt(i, this.config.whiteList, this.config.sanitizeFn)),
        ...
        n._enter = function(t, i) {
            ...
            e(i.getTipElement()).hasClass(Kt) || i._hoverState === $t ? i._hoverState = $t : (clearTimeout(i._timeout),
            i._hoverState = $t,
        ...
        n._getConfig = function(t) {
            ...
            t.sanitize && (t.template = Nt(t.template, t.whiteList, t.sanitizeFn)),
            t
        }
        ,
      ...
      , re = function(t) {
        ...
        i._jQueryInterface = function(t) {
            return this.each(function() {
                ...
                if ((n || !/dispose|hide/.test(t)) && (n || (n = new i(this,s),
                e(this).data(Zt, n)),
                "string" == typeof t)) {
                    if (void 0 === n[t])
    ...
    var ae = "scrollspy"
      ...
      , be = function() {
        function t(t, i) {
            ...
            this._selector = this._config.target + " " + me + "," + this._config.target + " " + ve + "," + this._config.target + " " + _e,
            this._offsets = [],
            this._targets = [],
        ...
        return i.refresh = function() {
            var t = this
              , i = this._scrollElement === this._scrollElement.window ? "offset" : ye
        ...
        i._getConfig = function(t) {
            ...
            return l.typeCheckConfig(ae, t, de),
            t
        }
        ,
        ...
        i._activate = function(t) {
            ...
            n.parents(ge).prev(me + ", " + ve).addClass(fe),
      ...
      , Ee = function() {
        ...
        return i.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(Te) || e(this._element).hasClass("disabled"))) {
                var i, n, s = e(this._element).closest(".nav, .list-group")[0], o = l.getSelectorFromElement(this._element);
                if (s) {
                    var r = "UL" === s.nodeName || "OL" === s.nodeName ? Se : De;
                    n = (n = e.makeArray(e(s).find(r)))[n.length - 1]
                }
                var a = e.Event(ke.HIDE, {
                    relatedTarget: this._element
                })
                  , h = e.Event(ke.SHOW, {
                    relatedTarget: n
        ...
        i._activate = function(t, i, n) {
            ...
            var o = this
              , r = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? e(i).children(De) : e(i).find(Se))[0]
              , a = n && r && e(r).hasClass("fade");
            if (r && a) {
                var h = l.getTransitionDurationFromElement(r);
                e(r).removeClass("show").one(l.TRANSITION_END, s).emulateTransitionEnd(h)
            } else
                s()
        }
        ,
    ...
    e(document).on(ke.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Ee._jQueryInterface.call(e(this), "show")
    }),
      ...
      , je = function() {
        ...
        return i.show = function() {
            ...
            !i.isDefaultPrevented()) {
                ...
                if (this._element.classList.remove(Me),
                l.reflow(this._element),
                this._element.classList.add(ze),
                this._config.animation) {
                    var s = l.getTransitionDurationFromElement(this._element);
                    e(this._element).one(l.TRANSITION_END, n).emulateTransitionEnd(s)
                } else
                    n()
            }
        }
        ...
        i.dispose = function() {
            clearTimeout(this._timeout),
            this._timeout = null,
            this._element.classList.contains(He) && this._element.classList.remove(He),
        ...
        ,
        i._getConfig = function(t) {
            return t = r({}, We, {}, e(this._element).data(), {}, "object" == typeof t && t ? t : {}),
        ...
        i._setListeners = function() {
            var t = this;
            e(this._element).on(Ne.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                return t.hide()
            })
        }
        ,
        i._close = function() {
            function t() {
                i._element.classList.add(Me),
                e(i._element).trigger(Ne.HIDDEN)
            }
            var i = this;
            if (this._element.classList.remove(He),
            this._config.animation) {
                var n = l.getTransitionDurationFromElement(this._element);
...
function(t) {
    ...
    var e, i, n, s, o, r, a = "Close", l = "BeforeClose", h = "MarkupParse", c = "Open", u = "Change", d = "mfp", p = "." + d, f = "mfp-ready", g = "mfp-removing", m = "mfp-prevent-close", v = function() {}, _ = !!window.jQuery, y = t(window), b = function(t, i) {
        e.ev.on(d + t + p, i)
    }, w = function(e, i, n, s) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!e.isOpen) {
                ...
                x("BeforeOpen"),
                e.st.showCloseBtn && (e.st.closeBtnInside ? (b(h, function(t, e, i, n) {
    ...
    ;
    var T, D, S, E = "inline", I = function() {
        S && (D.after(S.addClass(T)).detach(),
        S = null)
    };
...
function(t) {
    ...
    function() {
        ...
        t.fn.position = function(n) {
            ...
            n = t.extend({}, n);
            var c, d, p, f, g, m, v = t(n.of), _ = t.position.getWithinInfo(n.within), y = t.position.getScrollInfo(_), b = (n.collision || "flip").split(" "), w = {};
            return m = function(e) {
                var i = e[0];
                return 9 === i.nodeType ? {
                    width: e.width(),
            ...
            g.top += c[1],
            this.each(function() {
                var r, a, l = t(this), h = l.outerWidth(), u = l.outerHeight(), m = i(this, "marginLeft"), x = i(this, "marginTop"), C = h + m + i(this, "marginRight") + y.width, k = u + x + i(this, "marginBottom") + y.height, T = t.extend({}, g), D = e(w.my, l.outerWidth(), l.outerHeight());
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i, n) {
            var s, o, r, a, l, h, c, u, d, p, f = n.options, g = f.snapTolerance, m = i.offset.left, v = m + n.helperProportions.width, _ = i.offset.top, y = _ + n.helperProportions.height;
            for (d = n.snapElements.length - 1; d >= 0; d--)
                ...
                l - g > v || m > h + g || c - g > y || _ > u + g || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[d].item
                })),
                n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = g >= Math.abs(c - y),
                o = g >= Math.abs(u - _),
                r = g >= Math.abs(l - v),
                a = g >= Math.abs(h - m),
    ...
    t.extend(e.prototype, {
        ...
        parseDate: function(e, i, n) {
            ...
            if ("" === (i = "object" == typeof i ? "" + i : i + ""))
                return null;
            var s, o, r, a, l = 0, h = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff, c = "string" != typeof h ? h : (new Date).getFullYear() % 100 + parseInt(h, 10), u = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, d = (n ? n.dayNames : null) || this._defaults.dayNames, p = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, f = (n ? n.monthNames : null) || this._defaults.monthNames, g = -1, m = -1, v = -1, _ = -1, y = !1, b = function(t) {
        ...
        _generateHTML: function(t) {
            var e, i, n, s, o, r, a, l, h, c, u, d, p, f, g, m, v, _, y, b, w, x, C, k, T, D, S, E, I, A, P, O, N, M, H, z, L, W, j, R = new Date, F = this._daylightSavingAdjust(new Date(R.getFullYear(),R.getMonth(),R.getDate())), q = this._get(t, "isRTL"), B = this._get(t, "showButtonPanel"), $ = this._get(t, "hideIfNoPrevNext"), U = this._get(t, "navigationAsDateFormat"), Y = this._getNumberOfMonths(t), K = this._get(t, "showCurrentAtPos"), V = this._get(t, "stepMonths"), Q = 1 !== Y[0] || 1 !== Y[1], X = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear,t.currentMonth,t.currentDay) : new Date(9999,9,9)), G = this._getMinMaxDate(t, "min"), Z = this._getMinMaxDate(t, "max"), J = t.drawMonth - K, tt = t.drawYear;
            if (0 > J && (J += 12,
            tt--),
            Z)
            ...
            i = U ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt,J - V,1)), this._getFormatConfig(t)) : i,
            n = this._canAdjustMonth(t, -1, tt, J) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>" : $ ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + i + "</span></a>",
            s = this._get(t, "nextText"),
            s = U ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt,J + V,1)), this._getFormatConfig(t)) : s,
            o = this._canAdjustMonth(t, 1, tt, J) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + s + "</span></a>" : $ ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + s + "</span></a>",
            ...
            x = 0; Y[0] > x; x++) {
                ...
                k = 0; Y[1] > k; k++) {
                    ...
                    for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === x ? q ? o : n : "") + (/all|right/.test(D) && 0 === x ? q ? n : o : "") + this._generateMonthYearHeader(t, J, tt, G, Z, x > 0 || k > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    ...
                    H = 0; N > H; H++) {
                        for (S += "<tr>",
                        z = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(M) + "</td>" : "",
                        w = 0; 7 > w; w++)
                            L = m ? m.apply(t.input ? t.input[0] : null, [M]) : [!0, ""],
                            j = (W = M.getMonth() !== J) && !_ || !L[0] || G && G > M || Z && M > Z,
                            z += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (W ? " ui-datepicker-other-month" : "") + (M.getTime() === T.getTime() && J === t.selectedMonth && t._keyEvent || y.getTime() === M.getTime() && y.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (j ? " " + this._unselectableClass + " ui-state-disabled" : "") + (W && !v ? "" : " " + L[1] + (M.getTime() === X.getTime() ? " " + this._currentClass : "") + (M.getTime() === F.getTime() ? " ui-datepicker-today" : "")) + "'" + (W && !v || !L[2] ? "" : " title='" + L[2].replace(/'/g, "&#39;") + "'") + (j ? "" : " data-handler='selectDay' data-event='click' data-month='" + M.getMonth() + "' data-year='" + M.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;" : j ? "<span class='ui-state-default'>" + M.getDate() + "</span>" : "<a class='ui-state-default" + (M.getTime() === F.getTime() ? " ui-state-highlight" : "") + (M.getTime() === X.getTime() ? " ui-state-active" : "") + (W ? " ui-priority-secondary" : "") + "' href='#'>" + M.getDate() + "</a>") + "</td>",
                    ...
                    ++J > 11 && (J = 0,
                    tt++),
                    C += S += "</tbody></table>" + (Q ? "</div>" + (Y[0] > 0 && k === Y[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                b += C
            }
            return b += h,
        ...
        _generateMonthYearHeader: function(t, e, i, n, s, o, r, a) {
            var l, h, c, u, d, p, f, g, m = this._get(t, "changeMonth"), v = this._get(t, "changeYear"), _ = this._get(t, "showMonthAfterYear"), y = "<div class='ui-datepicker-title'>", b = "";
            if (o || !m)
                ...
                c = 0; 12 > c; c++)
                    (!l || c >= n.getMonth()) && (!h || s.getMonth() >= c) && (b += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + a[c] + "</option>");
                b += "</select>"
            }
            if (_ || (y += b + (!o && m && v ? "" : "&#xa0;")),
            !t.yearshtml)
    ...
    t.effects.define("bounce", function(e, i) {
        var n, s, o, r = t(this), a = e.mode, l = "hide" === a, h = "show" === a, c = e.direction || "up", u = e.distance, d = e.times || 5, p = 2 * d + (h || l ? 1 : 0), f = e.duration / p, g = e.easing, m = "up" === c || "down" === c ? "top" : "left", v = "up" === c || "left" === c, _ = 0, y = r.queue().length;
...
function() {
    ...
    e = function() {
        ...
        t.prototype.createEvent = function(t, e, i, n) {
            ...
            null == i && (i = !1),
            null == n && (n = null),
            null != document.createEvent ? (s = document.createEvent("CustomEvent")).initCustomEvent(t, e, i, n) : null != document.createEventObject ? (s = document.createEventObject()).eventType = t : s.eventName = t,
            s
        }
        ,
    ...
    this.WOW = function() {
                ...
                return function(e) {
                    ...
                    n = e.length; n > i; i++)
                        ...
                        r.push(function() {
                            ...
                            for (n = [],
                            t = 0,
                            e = (i = o.addedNodes || []).length; e > t; t++)
                                s = i[t],
                                n.push(this.doSync(s));
                            return n
                        }
                        .call(t));
                    return r
        ...
        s.prototype.doSync = function(t) {
            ...
            1 === t.nodeType) {
                for (o = [],
                i = 0,
                n = (s = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; n > i; i++)
                    e = s[i],
        ...
        s.prototype.vendorSet = function(t, e) {
            ...
            e)
                ...
                n.push(function() {
                    ...
                    for (a = [],
                    e = 0,
                    n = (r = this.vendors).length; n > e; e++)
                        o = r[e],
                        a.push(t["" + o + i.charAt(0).toUpperCase() + i.substr(1)] = s);
                    return a
                }
                .call(this));
            return n
        ...
        s.prototype.vendorCSS = function(t, e) {
            var i, s, o, r, a, l;
            for (r = (a = n(t)).getPropertyCSSValue(e),
            i = 0,
            s = (o = this.vendors).length; s > i; i++)
                l = o[i],
        ...
        s.prototype.isVisible = function(t) {
            ...
            s = (o = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset) + Math.min(this.element.clientHeight, this.util().innerHeight()) - i,
    ...
    e.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var a in this.waypoints[o]) {
                var l, h, c, u, d = this.waypoints[o][a], p = d.options.offset, f = d.triggerPoint, g = 0, m = null == f;
                d.element !== d.element.window && (g = d.adapter.offset()[r.offsetProp]),
                ...
                u = !h && !c,
                !m && (h && c) ? (d.queueTrigger(r.backward),
                n[d.group.id] = d.group) : !m && u ? (d.queueTrigger(r.forward),
                n[d.group.id] = d.group) : m && r.oldScroll >= d.triggerPoint && (d.queueTrigger(r.forward),
...
function(t, e, i, n) {
    ...
    s.prototype.render = function() {
        ...
        if (i.thumbsPrerendered ? (this._thumbcontent._thumbcontainer = t("." + i.thumbContainerClass),
        i.moveThumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element)) : this._thumbcontent._thumbcontainer = t("<div>").addClass(i.thumbContainerClass).appendTo(this.$element),
        i.thumbImage)
            for (e = 0; e < this._thumbcontent.length; ++e)
                this._thumbcontent._thumbcontainer.append("<button class=" + i.thumbItemClass + '><img src="' + this._thumbcontent[e].attr("src") + '" alt="' + this._thumbcontent[e].attr("alt") + '" /></button>');
        else
            for (e = 0; e < this._thumbcontent.length; ++e)
                this._thumbcontent._thumbcontainer.append("<button class=" + i.thumbItemClass + ">" + this._thumbcontent[e] + "</button>")
    }
    ,
    ...
    t.fn.countUp = function(e) {
        ...
        return this.each(function() {
            ...
            e.waypoint(function() {
                ...
                /^[0-9]+\.[0-9]+$/.test(o)), h = l ? (o.split(".")[1] || []).length : 0, c = s; c >= 1; c--) {
                    var u = parseInt(Math.round(o / s * c));
                    if (l && (u = parseFloat(o / s * c).toFixed(h)),
                    a)
                ...
                e.data("counterup-func", function() {
                    ...
                    e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), i) : (e.data("counterup-nums"),
...
function(t) {
    ...
    t.fn.paroller = function(l) {
        ...
        this.each(function() {
            ...
            "background" === b ? "vertical" === w ? n(u, C) : "horizontal" === w && s(u, C) : "foreground" === b && ("vertical" === w ? o(u, k, y, _) : "horizontal" === w && r(u, k, y, _)),
            t(window).on("resize", function() {
                ...
                "vertical" === w ? n(u, C) : "horizontal" === w && s(u, C)) : "foreground" === b && g <= c && (u.css({
                    transform: "unset",
                    transition: "unset"
                }),
                "vertical" === w ? o(u, k, y) : "horizontal" === w && r(u, k, y))
            }),
            t(window).on("scroll", function() {
                ...
                e || (window.requestAnimationFrame(i),
                e = !0),
                "background" === b ? "vertical" === w ? n(u, C) : "horizontal" === w && s(u, C) : "foreground" === b && g <= c && ("vertical" === w ? o(u, k, y, _) : "horizontal" === w && r(u, k, y, _))
            })
        })
    }
});
